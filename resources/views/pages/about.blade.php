			...
			<div class="row">
				<div class="col-sm-4 col-md-4">
					...
					<div class="box-image-2 margin-bottom-30">
						...
						<div class="description">Our team operates at a staggering level of professionalism. We believe we have an obligation to our customers and investors to do so.</div>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<!-- BOX 2 -->
					<div class="box-image-2 margin-bottom-30">
						...
						<div class="description">Yes, we maintain the highest level of Integrity and clarity. We do not leave communication open to intepretation.</div>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<!-- BOX 1 -->
					<div class="box-image-2 margin-bottom-30">
						...
						<div class="description">Safari is a blend of the best minds in Engineering and Business, our DNA is one that transcend academic qualification alone.</div>
					</div>
				</div>
